...
- 2026-03-10 - T0036 - Added a standalone synthetic evidence generator window/tool with deterministic `offense_window` dataset generation, required synthetic export-pack files/manifests/findings, and reproducibility/file-generation regression tests.
...
- 2026-03-17 - T0043 - Hotfixed gang documentation workflow clarity with state-specific action visibility, reversible purge-review and purge restore paths, draft-save handling for returned records, and updated regression coverage.
- 2026-03-18 - T0044 - Added approved-only gang documentation packet preview/export, template-driven HTML packet assembly with separated analyst/evidence/workflow sections, audited export logging, and deterministic packet/citation/approval regression coverage.
