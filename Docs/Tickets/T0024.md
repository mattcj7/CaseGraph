...
- Keep UI responsive; use paging + cancellation.
- No silent merges; reuse existing identity resolution logic.
- Keep build green; add tests; add migrations only if required.
